class StoresController < ApplicationController
  before_action :authenticate_admin, only: %i[ index new edit update destroy ]
  ...
  private
    ...
    def store_params
      params.require(:store).permit(:product_id, :name, :category, :description, :gender, :colour, :price, product_images: [])
    end
